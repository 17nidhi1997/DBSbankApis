...
namespace DBSBankComman.Model
{
    ...
    {
        public locModel1 header { get; set; }
        public locModel2 txnInfo { get; set; }
        public locModel4 txnDetails { get; set; }
        public List<locModel5> shipmentDetails { get; set; }
        public locModel6 transportDocsDetails { get; set; }
